...
export type Code = Errors[number]['code'];
export type NemIDErrorType = { cause: string, code: Code, message: { en: string, da: string } };

export class NemIDError extends Error {
	public code: Code;
	public userMessage: { en: string, da: string };
	public cause?: string;

	constructor (error: NemIDErrorType) {
		super(error.cause);
